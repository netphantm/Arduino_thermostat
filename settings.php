...
$SHA1 = x509_fingerprint($pem,$hash='sha1');
...
print("Host = <input type='text' name='host' size=11 value=$host>\n");
print("Port = <input type='text' name='httpsPort' size=1 value=$httpsPort><br>\n");
...
print("Temperature MAX = <input type='text' name='temp_max' size=1 value=$temp_min><br>\n");
